...
function with_jquery(t){var e=document.createElement("script");e.type="text/javascript",e.textContent="("+t.toString()+")(jQuery)",document.body.appendChild(e)}with_jquery(function(t){t(function(){function e(t){var e=t.caret(),n="backward"===t[0].selectionDirection;return n?(e.directedStart=e.end,e.directedEnd=e.start,e.backward=!0):(e.directedStart=e.start,e.directedEnd=e.end),e}function n(t,e,n,r){var a,i;2===arguments.length&&(n=e),r&&(a=e,e=n,n=a),e>n&&(a=e,e=n,n=a,i=!0),i&&u?t[0].setSelectionRange(e,n,"backward"):t.caret(e,n)}function r(e,n){"undefined"==typeof n&&(n=!l),l^n&&(t(e).css("opacity",n?1:.3),l=n)}function a(){var e=t(this),n=this.value||"",r=e.caret(),a=n.substring(0,r.end),i=(a.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];return/^[ \t]+$/.test(i)?c.call(this,!0):!0}function i(r){var a,i,c=t(this),s=this.value||"",u=e(c),h=s.substring(0,u.directedEnd),l=s.substring(u.directedEnd),o=(h.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];if(o.length){a=o.search(/[^ \t]/);var f=new RegExp("^ {0,"+(d-1)+"}	");(a>=d||a>0&&f.test(o))&&(i=u.directedEnd-o.length+a)}else a=(l.match(/^[\t ]*/)||[""])[0].length,a>0&&(i=u.directedEnd+a);return"undefined"!=typeof i?(r?n(c,u.directedStart,i):n(c,i),!1):!0}function c(r){var a,i,c=t(this),u=this.value||"",h=e(c),l=u.substring(0,h.start),o=u.substring(h.start,h.end),f=u.substring(h.end);if(h.start===h.end){var g,w=(l.match(/(?:^|\n)([^\n]*)$/)||["",""])[1],p=0;if(r&&!/(^|[ \t])$/.test(w))return!1;var v=!0;for(r&&!w.length&&(f=f.replace(/^[ \t]*/,function(t){return w=t,l+=t,""}),v=!1),g=0;g<w.length;g++)"	"===w.charAt(g)?p=0:p++;if(r){var y=w.length?p%d||d:d,b=new RegExp(" {0,"+(y-1)+"}[ \\t]$");l=l.replace(b,function(t){return a=-t.length,""})}else a=d-p%d,l+=s.slice(p%d);c.val(l+f),v||(a=0),c.caret(h.start+a,h.start+a)}else{if(l=l.replace(/(^|\n)([^\n]*)$/,function(t,e,n){return o=n+o,e}),r){a=0;var b=new RegExp("(^|\n)(	| {1,"+(d-1)+"}[ 	])","g");if(o=o.replace(b,function(t,e,n){return a||(i=d-n.length),a-=n.length,e}),!a)return!1}else a=0,i=0,o=o.replace(/^|\n/g,function(t){return a+=d,t+s});c.val(l+o+f),n(c,h.start+i,h.end+a,h.backward)}return!1}if(window.StackExchange&&StackExchange.ready){var d=4,s=" ".repeat(d),u="selectionDirection"in t("<textarea />")[0],h={9:{handler:c,allowShift:!0},36:{handler:i,allowShift:u},8:{handler:a}},l=!0,o=!1;t("#mainbar").on("keyup",".wmd-input",function(t){o&&17===t.which?r(this):r(this,!0)}),t("#mainbar").on("keydown",".wmd-input",function(t){if(o=17===t.which,t.ctrlKey||t.altKey||t.metaKey)return!0;var e=l;if(r(this,!0),!e)return!0;if(!h.hasOwnProperty(t.which))return!0;var n=h[t.which];return t.shiftKey&&!n.allowShift?!0:n.handler.call(this,t.shiftKey)})}})});
