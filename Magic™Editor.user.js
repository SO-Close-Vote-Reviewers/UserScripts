...
function with_jquery(t){var e=document.createElement("script");e.type="text/javascript",e.textContent="("+t.toString()+")(jQuery)",document.body.appendChild(e)}with_jquery(function(t){t(function(){function e(t){var e=t.caret(),n="backward"===t[0].selectionDirection;return n?(e.directedStart=e.end,e.directedEnd=e.start,e.backward=!0):(e.directedStart=e.start,e.directedEnd=e.end),e}function n(t,e,n,r){var a,i;2===arguments.length&&(n=e),r&&(a=e,e=n,n=a),e>n&&(a=e,e=n,n=a,i=!0),i&&h?t[0].setSelectionRange(e,n,"backward"):t.caret(e,n)}function r(e,n){"undefined"==typeof n&&(n=!l),l^n&&(t(e).css("opacity",n?1:.3),l=n)}function a(){var e=t(this),n=this.value||"",r=e.caret(),a=n.substring(0,r.end),i=(a.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];return/^[ \t]+$/.test(i)?c.call(this,!0):!0}function i(r){var a,i,c=t(this),s=this.value||"",h=e(c),u=s.substring(0,h.directedEnd),l=s.substring(h.directedEnd),o=(u.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];if(o.length){a=o.search(/[^ \t]/);var f=new RegExp("^ {0,"+(d-1)+"}	");(a>=d||a>0&&f.test(o))&&(i=h.directedEnd-o.length+a)}else a=(l.match(/^[\t ]*/)||[""])[0].length,a>0&&(i=h.directedEnd+a);return"undefined"!=typeof i?(r?n(c,h.directedStart,i):n(c,i),!1):!0}function c(r){var a,i,c=t(this),h=this.value||"",u=e(c),l=h.substring(0,u.start),o=h.substring(u.start,u.end),f=h.substring(u.end);if(u.start!==u.end&&/\n/.test(o)){if(l=l.replace(/(^|\n)([^\n]*)$/,function(t,e,n){return o=n+o,e}),r){a=0;var g=new RegExp("(^|\n)(	| {1,"+(d-1)+"}[ 	])","g");o=o.replace(g,function(t,e,n){return a||(i=d-n.length),a-=n.length,e})}else a=0,i=0,o=o.replace(/^|\n/g,function(t){return a+=d,t+s});c.val(l+o+f),n(c,u.start+i,u.end+a,u.backward)}else{var w,p=(l.match(/(?:^|\n)([^\n]*)$/)||["",""])[1],v=0;if(r&&!/(^|[ \t])$/.test(p))return!1;var y=!0;for(r&&!p.length&&(f=f.replace(/^[ \t]*/,function(t){return p=t,l+=t,""}),y=!1),w=0;w<p.length;w++)"	"===p.charAt(w)?v=0:v++;if(r){var b=p.length?v%d||d:d,g=new RegExp(" {0,"+(b-1)+"}[ \\t]$");l=l.replace(g,function(t){return a=-t.length,""})}else a=d-v%d,l+=new Array(a+1).join(" ");c.val(l+f),y||(a=0),c.caret(u.start+a,u.start+a)}return!1}if(window.StackExchange&&StackExchange.ready){var d=4,s=" ".repeat(d),h="selectionDirection"in t("<textarea />")[0],u={9:{handler:c,allowShift:!0},36:{handler:i,allowShift:h},8:{handler:a}},l=!0,o=!1;t("#mainbar").on("keyup",".wmd-input",function(t){o&&17===t.which?r(this):r(this,!0)}),t("#mainbar").on("keydown",".wmd-input",function(t){if(o=17===t.which,t.ctrlKey||t.altKey||t.metaKey)return!0;var e=l;if(r(this,!0),!e)return!0;if(!u.hasOwnProperty(t.which))return!0;var n=u[t.which];return t.shiftKey&&!n.allowShift?!0:n.handler.call(this,t.shiftKey)})}})});
