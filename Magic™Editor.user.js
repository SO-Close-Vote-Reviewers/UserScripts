...
function with_jquery(t){var e=document.createElement("script");e.type="text/javascript",e.textContent="("+t.toString()+")(jQuery)",document.body.appendChild(e)}with_jquery(function(t){t(function(){function e(t){var e=t.caret(),n="backward"===t[0].selectionDirection;return n?(e.directedStart=e.end,e.directedEnd=e.start,e.backward=!0):(e.directedStart=e.start,e.directedEnd=e.end),e}function n(t,e,n,r){var a,i;2===arguments.length&&(n=e),r&&(a=e,e=n,n=a),e>n&&(a=e,e=n,n=a,i=!0),i&&d?t[0].setSelectionRange(e,n,"backward"):t.caret(e,n)}function r(e,n){"undefined"==typeof n&&(n=!u),u^n&&(t(e).css("opacity",n?1:.3),u=n)}function a(){var e=t(this),n=this.value||"",r=e.caret(),a=n.substring(0,r.end),i=(a.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];return/^[ \t]+$/.test(i)?c.call(this,!0):!0}function i(r){var a,i,c=t(this),d=this.value||"",h=e(c),u=d.substring(0,h.directedEnd),s=d.substring(h.directedEnd),l=(u.match(/(?:^|\n)([^\n]*)$/)||["",""])[1];return l.length?(a=l.search(/[^ \t]/),(a>3||a>0&&/^ {0,3}\t/.test(l))&&(i=h.directedEnd-l.length+a)):(a=(s.match(/^[\t ]*/)||[""])[0].length,a>0&&(i=h.directedEnd+a)),"undefined"!=typeof i?(r?n(c,h.directedStart,i):n(c,i),!1):!0}function c(r){var a,i,c=t(this),d=this.value||"",h=e(c),u=d.substring(0,h.start),s=d.substring(h.start,h.end),l=d.substring(h.end);if(h.start!==h.end&&/\n/.test(s))u=u.replace(/(^|\n)([^\n]*)$/,function(t,e,n){return s=n+s,e}),r?(a=0,s=s.replace(/(^|\n)(\t| {1,3}[ \t])/g,function(t,e,n){return a||(i=-n.length),a-=n.length,e})):(a=0,i=4,s=s.replace(/^|\n/g,function(t){return a+=4,t+"    "})),c.val(u+s+l),n(c,h.start+i,h.end+a,h.backward);else{var o,f=(u.match(/(?:^|\n)([^\n]*)$/)||["",""])[1],g=0;if(r&&!/(^|[ \t])$/.test(f))return!1;var w=!0;for(r&&!f.length&&(l=l.replace(/^[ \t]*/,function(t){return f=t,u+=t,""}),w=!1),o=0;o<f.length;o++)"	"===f.charAt(o)?g=0:g++;if(r){var p=f.length?g%4||4:4,v=new RegExp(" {0,"+(p-1)+"}[ \\t]$");u=u.replace(v,function(t){return a=-t.length,""})}else a=4-g%4,u+=new Array(a+1).join(" ");c.val(u+l),w||(a=0),c.caret(h.start+a,h.start+a)}return!1}if(window.StackExchange&&StackExchange.ready){var d="selectionDirection"in t("<textarea />")[0],h={9:{handler:c,allowShift:!0},36:{handler:i,allowShift:d},8:{handler:a}},u=!0,s=!1;t("#mainbar").on("keyup",".wmd-input",function(t){s&&17===t.which?r(this):r(this,!0)}),t("#mainbar").on("keydown",".wmd-input",function(t){if(s=17===t.which,t.ctrlKey||t.altKey||t.metaKey)return!0;var e=u;if(r(this,!0),!e)return!0;if(!h.hasOwnProperty(t.which))return!0;var n=h[t.which];return t.shiftKey&&!n.allowShift?!0:n.handler.call(this,t.shiftKey)})}})});
