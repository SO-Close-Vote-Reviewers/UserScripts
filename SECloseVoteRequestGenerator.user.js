...
(function() {
    ...
    var knownOptions = {
        checkboxes: {
            ...
            alwaysCharcoal:                    new CheckboxOption(false, 'Always send SD actions to Charcoal HQ.', 'Regardless of the current room selection, always send SD commands to Charcoal HQ and show the SD command options on all sites.'),
